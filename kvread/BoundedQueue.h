...
// This code is from http://www.1024cores.net/home/lock-free-algorithms/queues/bounded-mpmc-queue
...
public:
    ...
    mpmc_bounded_queue_t(
        ...
        for (size_t i = 0; i < _size; ++i) {
            ...
            _buffer[i].data.initRecord(100); // fix enqueue with KVTuple's init record
        }
    }
    ...
    enqueue(const T& data){
        ...
        for (;;) {
            ...
            if (dif == 0) {
                ...
                // this branch should never be taken under normal circumstances
